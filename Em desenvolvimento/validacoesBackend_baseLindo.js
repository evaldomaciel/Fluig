...
function createDataset(fields, constraints, sortFields) {
	...
	try {
		...
		for (var index = 0; index < iterator.length; index++) {
			...
			if (element.indexOf("tx_praticantenome___") >= 0 || element.indexOf("tx_praticantecpf___") >= 0 || element.indexOf("tx_praticantestatus___") >= 0) {
				dataset.addRow([element, lista[element]]);
			}
		}
